...
$interestData = $connection->query("SELECT * FROM interest");
$careerData = $connection->query("SELECT * FROM career");
$expriensData = $connection->query("SELECT * FROM expriens");
$projectData = $connection->query("SELECT * FROM project");
...
<div class="wrapper">
    <div class="sidebar-wrapper">
        ...
        <div class="contact-container container-block">
            <ul class="list-unstyled contact-list">
                <li class="email"><i class="fa fa-envelope"></i><a
                            href="mailto: <?php echo $aboutData['mail'] ?>"><?php echo $aboutData['mail'] ?></a></li>
                <li class="phone"><i class="fa fa-phone"></i><a
                            href="tel:<?php echo $aboutData['tel'] ?>"><?php echo $aboutData['tel'] ?></a></li>
                <li class="website"><i class="fa fa-globe"></i><a href="<?php echo $aboutData['site'] ?>"
                                                                  target="_blank"><?php echo $aboutData['site'] ?></a>
                </li>
            </ul>
        ...
        <div class="education-container container-block">
            ...
            <?php foreach ($educationData as $aduc): ?>
                <div class="item">
                    ...
                    <h5 class="meta"><?php echo $aduc['sity'] ?></h5>
                    <div class="time"><?php echo $aduc['year_start'] ?> - <?= $aduc['year_end'] ?></div>
                </div><!--//item-->
            <?php endforeach; ?>
        ...
        <div class="languages-container container-block">
            ...
            <ul class="list-unstyled interests-list">
                <?php foreach ($languagesData as $lang): ?>
                    <li><?= $lang['lang'] ?> <span class="lang-desc">(Native)</span></li>
                <?php endforeach; ?>
            </ul>
        </div><!--//interests-->
        ...
        <div class="interests-container container-block">
            ...
            <ul class="list-unstyled interests-list">
                <?php foreach ($interestData as $int) : ?>
                    <li><?= $int['interes'] ?> </li>
                <?php endforeach; ?>
            </ul>
        </div><!--//interests-->
    ...
    <div class="main-wrapper">
        ...
        <section class="section projects-section">
            ...
            <div class="item">
                <span class="project-title"><a href="#hook"><?php echo $proj['studio'] ?></a></span> - <span
                        class="project-tagline"><?php echo $proj['description'] ?></span>
                <?php endforeach; ?>
        </section><!--//section-->
        ...
        <section>
            <form action="" method="POST">
                ...
                <input type="text" name="comment" placeholder="коментарий" required>
                <input type="submit">
            </form>
        </section>
        <?php if ($data != false) : ?>
            <?php foreach ($data as $com) : ?>
                <?php echo $com['name'] . " " . $com['comment'] ?><br>
            <?php endforeach ?>
        <?php else : ?>
