...
ymaps.ready(function () {
    ymaps.util.augment(GeolocationButton, ymaps.control.Button, {
        ...
        _onBtnClick: function (e) {
            ...
            this.toggleIconImage('/images/wifi.png');
        ...
        _onGeolocationSuccess: function (position) {
			var bc_coord1 = position['coords']['latitude'];
			var bc_coord2 = position['coords']['longitude'];
			myPlacemark.geometry.setCoordinates([bc_coord1,bc_coord2]);
            this.handleGeolocationResult(position);

			setTimeout(function(){
				document.getElementById("latlongmet").value = bc_coord1+','+bc_coord2;
				get_address(1);
								}, 500);
